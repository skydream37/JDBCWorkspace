	...
	public static void main(String[] args) {
		...
		try {
			...
			while (rs.next()) {
				...
				/*
				 * String empno = rs.getString("empno"); String ename =
				 * rs.getString("ename"); String hiredate =
				 * rs.getString("hiredate"); // 2004-12-25 00:00:00.0 String
				 * salary = rs.getString("salary"); // 56000.00
				 * 
				 * Object empno = rs.getObject("empno"); Object ename =
				 * rs.getObject("ename"); Object hiredate =
				 * rs.getObject("hiredate"); // 2004-12-25 00:00:00.0 Object
				 * salary = rs.getObject("salary"); // 56000.00
				 * 
				 ...
				 * java.sql.Date extends java.util.Date double salary =
				 * rs.getDouble(4); // 56000.0
				 */
